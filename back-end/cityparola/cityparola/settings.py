"""
Django settings for cityparola project.
...
SECRET_KEY = 'django-insecure-z_+2%c=q&3i4l#((&ol_5@(+-*l%lxq(y@ip!nw!m_i345tblj'
...
WSGI_APPLICATION = 'cityparola.wsgi.application'
